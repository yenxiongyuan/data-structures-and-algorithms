...
1-Write a function called addTwo that takes in an array ->> const addTwo = (arr) => {}
2-adds two to every value using a for loop ->> const newArr = arr.map((num) => {}
------------------------------------------------------------------------------------------------ */
...
1-Write a function named typeNum that, given an array as input ->> const typeNum = (arr) => {}
2-uses filter to return an array containing only the numbers ->> arr.filter(num)
...
1-Write a function named containsAnd that, given an array of strings as input --> const containsAnd = (arr) => {}
2-uses filter to return an array containing only strings that contain 'and' within the string
3-
...
1-Write a function named oddValues that, given an array of integers as input
2-uses filter to return an array containing only the odd integers
...
1. Write a function named notInFirstArray that, given two arrays as input,
2. uses filter to return an array of all the elements in the second array that are not included in the first array.
...
const notInFirstArray = (forbiddenValues, arr) => {
  ...
  return arr.filter((elmInculd) => {
    // console.log(elmInculd)
    if(!forbiddenValues.includes(elmInculd)){
      return true;
    }
  });
};
